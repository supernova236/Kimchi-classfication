# -*- coding: utf-8 -*-
"""kimchi_CNN_augmentation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1VMiZT447zzn8zvL2fdmY6o5-3arln3lo
...
kimch_train_augmented = datasets.ImageFolder(root=os.path.join(dataset_path, 'train'), transform=augmentation_trans)
kimch_valid_augmented = datasets.ImageFolder(root=os.path.join(dataset_path, 'val'), transform=augmentation_trans)
...
train_loader = DataLoader(kimch_train_augmented, batch_size=batch_size, shuffle=True, num_workers=2)
val_loader = DataLoader(kimch_valid_augmented, batch_size=batch_size, shuffle=False, num_workers=2)
